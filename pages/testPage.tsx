      ...
      <div className='mt-4'>
        <div className='prose mx-auto'>
          ...
          **$100** to play. Your bet is put into the pot. Your payoff is
          determined by **10** consecutive coin tosses. * After each heads the
          pot is{' '}
          <span className='font-extrabold text-green-700'>increased 50%</span>.
          * After each tails the pot is{' '}
          ...
          mathematics at MIT. He{"'"}s rather busy. You explain the situation
          and he jots it all down. After a few minutes he says the expected
          value of the pot at the end of the game is about **$162.88**. He
          wishes you luck as he hurries off the phone to make it to office
          hours.
          <figure>
            <UnsplashImage
          ...
          <Chassis>
            ...
            <p>
              This article was inspired by the work of Ole Peters in the field
              of ergodicity economics.
              <br />
              Visit his{' '}
              <a
